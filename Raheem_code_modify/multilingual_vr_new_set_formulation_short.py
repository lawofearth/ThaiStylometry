...
my_data = loadtxt('/home/grads/raheem/multilingual_vr_features/extension/raheem_crosslingual_vr_features_short_training.csv', delimiter=',')
#my_data = np.asarray(multiprocessLoad("../../splitedFiles1000000"))
print time.time()-start, "used to read file"
#parameters
D=9  #dimensions
L=200  # the number of group hash default is 200
K=4   # the number of hash functions in each group hash
...
NDocQ = 100
R=0.12* math.sqrt(D)    # query range default is 0.12
W=1.4 # the width of bucket default is 1.2
T=20   # collision threshold default is 20
...
doc=[]
line=linecache.getlines("/home/grads/raheem/multilingual_vr_features/crosslingual_stats_short_testing.csv")
...
def queryExp(q):
    ...
    try:    
        ...
        fileNameString = "./expResult10K_new_short/" + str(q)
